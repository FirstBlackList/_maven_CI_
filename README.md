[![Java CI with Maven](https://github.com/FirstBlackList/_maven_CI_/actions/workflows/maven.yml/badge.svg)](https://github.com/FirstBlackList/_maven_CI_/actions/workflows/maven.yml)
